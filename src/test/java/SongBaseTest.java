...
public class SongBaseTest {
    ...
    DynamicTest[] allTests() {
        return new DynamicTest[] {
            ...
            songTest("shuffle2", "--out - --shuffle %Playsorted1.m3u%  >%Playmixed1.m3u%"),
            songTest("shuffle3", "--out - --shuffle %Playsorted2.m3u8% >%Playmixed2.m3u8%"),
            songTest("sort2", "--out - --sort %shuffle2:Playmixed1.m3u=%  >%=Playsorted1.m3u%"),
            songTest("sort3", "--out - --sort %shuffle3:Playmixed2.m3u8=% >%=Playsorted2.m3u8%"),
